    ...
    public class JWTService : IJWTService
    {
        ...
        public async Task<string> GenerateTokenAsync(UserEntity user)
        {
            ...
            var tokenDescriptor = new SecurityTokenDescriptor()
            {
                ...
                NotBefore = DateTime.Now.AddDays(Convert.ToDouble(_appSettingData.JWTSettings.NotBeforeMinutes)),
                Expires = DateTime.Now.AddDays(Convert.ToDouble(_appSettingData.JWTSettings.ExpirationMinutes)),
